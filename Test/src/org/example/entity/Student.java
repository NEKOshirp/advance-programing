...
public class Student extends Person implements NotifyInterface {
    ...
    public Student(int id, String name, String address, String phone, String personId, Date birthDay, String email, int parentID, String studentCode, String groupCode, float gpa) {
